...
#define GPIO_INPUT_PIN GPIO_NUM_9//按键引脚宏定义
...
static void http_rest_with_url(void)
{
    ...
    esp_http_client_config_t config = {
        .url = "https://api.map.baidu.com/weather/v1/?district_id=310100&data_type=all&ak=bKMglkZKGFFk0G0SlNeIUiKMNq4WVmDo",
    ...
    cJSON *root = cJSON_Parse(local_response_buffer);//解析json字符串
