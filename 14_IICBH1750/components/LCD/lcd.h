...
/*LCD引脚定义*/
#define LCD_RST_PIN    GPIO_NUM_21  // 复位引脚
#define LCD_DC_PIN     GPIO_NUM_47  // 数据/命令引脚
#define LCD_CS_PIN     GPIO_NUM_45  // 片选引脚
#define LCD_BLK_PIN    GPIO_NUM_40  // 背光引脚

/*GPIO引脚控制宏定义*/
#define LCD_RST(x)  x ? gpio_set_level(LCD_RST_PIN,1) : gpio_set_level(LCD_RST_PIN,0)
...
#define LCD_BLK(x)  x ? gpio_set_level(LCD_BLK_PIN,1) : gpio_set_level(LCD_BLK_PIN,0)
